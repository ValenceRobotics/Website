    ...
    return (
        <div>
            ...
            <div className="flex justify-center mt-8 items-center gap-x-4 gap-y-4 flex-wrap">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-center text-black align-middle">Fill out the <a href="" className="text-light-orange underline hover:text-dark-orange">member information form</a></h2>
            </div> 
        </div>
    );
}
