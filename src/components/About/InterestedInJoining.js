    ...
    return (
        <div>
            <div className="flex justify-evenly">
                <h1 className="text-4xl font-bold text-center text-light-orange font-heading">Interested <span className="text-black">in</span> Joining?</h1>
            </div>
